...
function passPrompt() {
  var click = prompt("Thank you for having a good security first mindset.  Please select what you would like to include in your pasword from the following prompts.")
}
